...
setopt APPEND_HISTORY       # Append new commands to the history file instead of overwriting
setopt INC_APPEND_HISTORY   # Incrementally append commands to the history file as you type them
setopt SHARE_HISTORY        # Share history across multiple running shells
setopt HIST_IGNORE_DUPS     # Avoid duplicate entries in history
